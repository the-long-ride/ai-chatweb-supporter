(() => {
  ...
  const api={getComposerText,setComposerText,isElementVisible,isButtonReady,firstVisible,themeContext,classifySendAttempt,canPrepareQueuedSend,requestComposerSubmit,fileInputs,selectedFiles,findFileInput,assignFilesToInput,clearFileInputs};
